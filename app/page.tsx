...
const FAQ_ITEMS = [
  { q: "Quantos carrosséis posso criar por mês?", a: "Depende do plano e de quantas imagens de IA você usa. Com imagem em todos os slides: Starter faz ~7, Pro ~25 e Studio ~75 por mês. Só com a capa, que é o mais comum, o Pro faz ~35. Editar o que foi gerado nunca custa token. No teste grátis você monta 1 carrossel completo." },
