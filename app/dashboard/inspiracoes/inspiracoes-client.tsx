...
import { Lightbulb, Flame, ArrowRight, Filter, Sparkles } from "lucide-react"
import {
...
export function InspiracoesClient({ inspiracoes, brandName }: Props) {
  ...
  function useInspiracao(insp: InspiracaoView) {
    try {
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto pb-24 lg:pb-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-text-secondary">
          {brandName ? (
            <>
              Ideias selecionadas pro nicho e objetivo da{" "}
