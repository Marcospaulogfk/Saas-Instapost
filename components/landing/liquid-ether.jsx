/*
 * LiquidEther — simulacao de fluido em WebGL usada como fundo do hero.
 *
 * Fonte: React Bits (MIT) - reactbits.dev, componente Backgrounds/LiquidEther.
 * Mantido proximo do original de proposito: e um solver de Navier-Stokes
 * (adveccao BFECC, viscosidade e Poisson por Jacobi) e qualquer "limpeza"
 * aqui vira artefato visual. So o import do CSS saiu - a classe
 * `.liquid-ether-container` vive em app/globals.css.
 */
