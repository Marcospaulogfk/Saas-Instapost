...
const templates = [
  {
    ...
    name: "Wesley Style",
    usageCount: 234,
    color: "bg-gradient-to-br from-brand-500 via-violet-700 to-zinc-950",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "Cinematic",
    usageCount: 156,
    color: "bg-gradient-to-br from-violet-700 via-brand-900 to-black",
  },
  {
    id: 4,
    name: "Bold Lime",
    usageCount: 142,
    color: "bg-gradient-to-br from-brand-700 via-zinc-900 to-black",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {templates.map((template, i) => (
          <motion.div
            ...
            className={`group relative aspect-[4/5] rounded-xl overflow-hidden border ${
              "accent" in template && template.accent === "lime"
                ? "border-[rgba(124,92,255,0.35)] hover:border-lime hover:glow-lime"
                : "border-border-subtle hover:border-brand-600/50 hover:shadow-glow-sm"
          ...
          >
            ...
            {"accent" in template && template.accent === "lime" && (
              <div className="absolute top-3 right-3 w-2 h-2 rounded-full bg-lime shadow-[0_0_12px_rgba(124,92,255,0.8)] animate-pulse" />
            )}
