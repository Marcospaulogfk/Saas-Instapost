...
export function QuickActionCard() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-brand-700/40 group"
      style={{
        background:
    ...
    >
      ...
      {/* Orbs animados */}
      <motion.div
        className="absolute -top-20 -right-10 w-72 h-72 rounded-full bg-brand-600/30 blur-3xl pointer-events-none"
      ...
      <div className="relative z-10 p-8 md:p-10 grid md:grid-cols-[1fr_auto] gap-8 items-center">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[rgba(124,92,255,0.12)] border border-[rgba(124,92,255,0.4)] backdrop-blur-md text-xs text-lime mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-lime shadow-[0_0_10px_rgba(124,92,255,0.7)] animate-pulse" />
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-white/55 mb-6">
            <span className="flex items-center gap-1.5"><Zap className="w-3.5 h-3.5 text-brand-300" /> Roteiro em 30s</span>
            <span className="flex items-center gap-1.5"><Brain className="w-3.5 h-3.5 text-brand-300" /> Estratégia adaptada</span>
            <span className="flex items-center gap-1.5"><Wand2 className="w-3.5 h-3.5 text-brand-300" /> Imagens IA</span>
          </div>

          <Button
            asChild
            size="lg"
            className="group/btn bg-lime text-white hover:bg-lime hover:brightness-110 glow-lime hover:shadow-[0_0_28px_rgba(124,92,255,0.5)] font-semibold"
          >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[140px] h-[180px] rounded-2xl bg-gradient-to-br from-brand-800/60 to-zinc-950/80 border border-white/10 backdrop-blur-md rotate-[12deg] translate-x-7 translate-y-3 shadow-2xl"
          >
          ...
          <motion.div
            ...
            className="absolute w-[140px] h-[180px] rounded-2xl bg-gradient-to-br from-brand-600/70 to-brand-900/90 border border-white/15 backdrop-blur-md rotate-[6deg] translate-x-3 shadow-2xl"
          >
            <div className="p-4 space-y-1.5">
          ...
          <motion.div
            ...
            className="relative w-[140px] h-[180px] rounded-2xl bg-gradient-to-br from-zinc-900 via-brand-950 to-black border border-brand-500/40 shadow-glow-xl overflow-hidden"
          >
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-1">
                  {[0, 1, 2, 3].map((i) => (
                    <span
                      key={i}
                      className={`w-1.5 h-1.5 rounded-full ${i === 0 ? "bg-lime shadow-[0_0_6px_rgba(124,92,255,0.7)]" : "bg-white/25"}`}
                    />
                  ))}
                </div>
