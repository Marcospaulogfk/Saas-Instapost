...
const plans = [
  {
    ...
    features: [
      "300 tokens/mes (≈ 60 imagens normais)",
      "1 marca configurada",
      "Templates basicos",
      "Imagem normal (Flux / Nano Banana normal)",
      "Nano Banana Pro nao incluido",
  ...
  },
  {
    ...
    features: [
      "1.000 tokens/mes (≈ 200 imagens normais)",
      "5 marcas configuradas",
      "Nano Banana Pro liberado (qualidade maxima)",
      "Sem marca d'agua",
  ...
  },
  {
    ...
    ctaVariant: "outline" as const,
    features: [
      "3.000 tokens/mes (≈ 600 imagens normais)",
      "Marcas ilimitadas",
      "Nano Banana Pro liberado (qualidade maxima)",
      "API para automacao",
