    ...
    >
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            accent === "primary"
              ? "0 24px 60px -12px rgba(22, 104, 227, 0.35), 0 0 0 1px rgba(22, 104, 227, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.05)"
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(22, 104, 227, 0.25), transparent 60%)",
          }}
        />
        ...
        <div className="relative p-4 flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #5595F1, #1668E3)",
              }}
            />
          ...
          <div
            ...
            style={{
              ...
              color: "#D5C8F0",
              border: "0.5px solid rgba(22, 104, 227, 0.4)",
            }}
          >
            NEW
          </div>
        ...
        <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between">
          <div
            ...
            style={{ background: "linear-gradient(90deg, #5595F1, #1668E3)" }}
          />
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 0 8px rgba(22, 104, 227, 0.6)",
            }}
            animate={{
              y: [0, -800],
              opacity: [0, 0.8, 0.8, 0],
